<script lang="ts">
  ...
  const C = {
    ...
    accent: '#9a1e30', win: '#34d399', danger: '#ff5f6d', gold: '#f4c451',
  };
  ...
  const LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    <circle cx="16" cy="16" r="15.3" fill="#5f1420"/>
    <g fill="#eef2f6">
  ...
  async function render() {
    ...
    glow.addColorStop(0, 'rgba(154,30,48,0.28)');
    glow.addColorStop(1, 'rgba(154,30,48,0)');
    ctx.fillStyle = glow;
    ctx.fillRect(0, 0, W, H);
